...
function prnxml($id_doc, $f_name){
    ...
    $txt_sql = "SELECT `DocTab`.`id` as idstr , `DocTab`.`nomstr`, `Tovar`.`Kod`, "
                   . "`Tovar`.`Kod1C`, `Tovar`.`Tovar` , `Tovar`.`ed_izm` , `DocTab`.`Cena`,"
...
//echo '<br>' . $txt_sql.'<br>';
    ...
    $rekv_nalog = "тел.: "  . $s_arr['tel_firm']; 
    $adres        = ""  . $s_arr['adres'];
    $ipn          = 'IПН:' . $s_arr['INN'];
    $info_nalog   = $s_arr['Info_nalog'];
    $gorod        = ""  . $s_arr['nom_svid'];
    $otv0 = '*ВІДПОВІДАЛЬНИЙ ЗА ЗДІЙСНЕННЯ ГОСПОДАРСЬКОЇ';
    $otv1 = 'ОПЕРАЦІЇ І ПРАВИЛЬНІСТЬ ЇЇ ОФОРМЛЕННЯ';
   ...
   <table:table table:name="Sheet1" table:style-name="ta1">
    ...
    <table:table-row table:style-name="ro2">
     ...
     <table:table-cell table:style-name="ce10" office:value-type="string" table:number-columns-spanned="7" table:number-rows-spanned="1">
      <text:p>Накладна № '.$nom_doc.' від '.$data_doc.' р.</text:p>
     </table:table-cell>
...
<table:table-cell table:style-name="ce3" table:number-columns-repeated="1"/>
    ...
    <table:table-row table:style-name="ro12">
     <table:table-cell table:style-name="ce7" office:value-type="string">
      <text:p>*Вiдвантажив:</text:p>
     </table:table-cell>
     <table:table-cell table:style-name="ce21"/> 
     <table:table-cell table:style-name="ce21"/> 
     <table:table-cell table:number-columns-repeated="2"/>
     <table:table-cell table:style-name="ce7" office:value-type="string">
        <text:p>Прийняв:</text:p>
     </table:table-cell>
    <table:table-cell table:style-name="ce21"/> 
