...
function addinxml( $name, $cena, $cena_opt, $cena_kropt, $hkod, $strhkod ,  $kod1c, $break_page, $txt_kropt , $txt_opt) {
 ...
 if($break_page){
    ...
    for ($j = 0; $j < 6; $j++) { 
       ...
       // золотое перо не печатаем ни кр опрт ни опт
  ...
  $str = '
    ...
    <table:table-row table:style-name="ro2">
     ...
     <table:table-cell table:style-name="ce10"  '.$txtcenaopt[0].' table:number-columns-spanned="1" table:number-rows-spanned="3">
     ...
     <table:table-cell table:style-name="Default"/>
     <table:table-cell table:style-name="ce10"  '.$txtcenaopt[1].' table:number-columns-spanned="1" table:number-rows-spanned="3">
     ...
     <table:table-cell table:style-name="Default"/>
     <table:table-cell table:style-name="ce10"  '.$txtcenaopt[2].' table:number-columns-spanned="1" table:number-rows-spanned="3">
     ...
     <table:table-cell table:style-name="Default"/>
     <table:table-cell table:style-name="ce10"  '.$txtcenaopt[3].' table:number-columns-spanned="1" table:number-rows-spanned="3">
      <text:p>'.$cena_opt[3].'</text:p>
     </table:table-cell>
     <table:table-cell table:style-name="ce12"/>
     <table:table-cell table:style-name="ce3" office:value-type="float" office:value="'.$cena[4].'" table:number-columns-spanned="1" table:number-rows-spanned="2">
      <text:p>'.$cena[4].'</text:p>
     </table:table-cell>
     <table:table-cell table:style-name="Default"/>
     <table:table-cell table:style-name="ce10"  '.$txtcenaopt[4].' table:number-columns-spanned="1" table:number-rows-spanned="3">
      <text:p>'.$cena_opt[4].'</text:p>
     </table:table-cell>
     <table:table-cell table:style-name="ce12"/>
     <table:table-cell table:style-name="ce3" office:value-type="float" office:value="'.$cena[5].'" table:number-columns-spanned="1" table:number-rows-spanned="2">
      <text:p>'.$cena[5].'</text:p>
     </table:table-cell>
     <table:table-cell table:style-name="Default"/>
     <table:table-cell table:style-name="ce10"  '.$txtcenaopt[5].' table:number-columns-spanned="1" table:number-rows-spanned="3">
      <text:p>'.$cena_opt[5].'</text:p>
     </table:table-cell>
     <table:table-cell table:style-name="ce12"/>
     <table:table-cell table:number-columns-repeated="203"/>
    </table:table-row>
    ...
    <table:table-row table:style-name="ro1">
     <table:table-cell table:style-name="ce5" office:value-type="float" office:value="'.$kod1c[0].'" table:number-columns-spanned="2" table:number-rows-spanned="1">
      <text:p>'.$kod1c[0].'</text:p>
     </table:table-cell>
     <table:covered-table-cell table:number-columns-repeated="2" table:style-name="ce9"/>
     <table:table-cell table:style-name="ce14"/>
     <table:table-cell table:style-name="ce5" office:value-type="float" office:value="'.$kod1c[1].'" table:number-columns-spanned="2" table:number-rows-spanned="1">
      <text:p>'.$kod1c[1].'</text:p>
     </table:table-cell>
     <table:covered-table-cell table:number-columns-repeated="2" table:style-name="ce9"/>
     <table:table-cell table:style-name="ce14"/>
     <table:table-cell table:style-name="ce5" office:value-type="float" office:value="'.$kod1c[2].'" table:number-columns-spanned="2" table:number-rows-spanned="1">
      <text:p>'.$kod1c[2].'</text:p>
     </table:table-cell>
     <table:covered-table-cell table:number-columns-repeated="2" table:style-name="ce9"/>
     <table:table-cell table:style-name="ce14"/>
     <table:table-cell table:style-name="ce5" office:value-type="float" office:value="'.$kod1c[3].'" table:number-columns-spanned="2" table:number-rows-spanned="1">
      <text:p>'.$kod1c[3].'</text:p>
     </table:table-cell>
     <table:covered-table-cell table:number-columns-repeated="2" table:style-name="ce9"/>
     <table:table-cell table:style-name="ce14"/>
     <table:table-cell table:style-name="ce5" office:value-type="float" office:value="'.$kod1c[4].'" table:number-columns-spanned="2" table:number-rows-spanned="1">
      <text:p>'.$kod1c[4].'</text:p>
     </table:table-cell>
     <table:covered-table-cell table:number-columns-repeated="2" table:style-name="ce9"/>
     <table:table-cell table:style-name="ce14"/>
     <table:table-cell table:style-name="ce5" office:value-type="float" office:value="'.$kod1c[5].'" table:number-columns-spanned="2" table:number-rows-spanned="1">
      <text:p>'.$kod1c[5].'</text:p>
     </table:table-cell>
     <table:covered-table-cell table:number-columns-repeated="2" table:style-name="ce9"/>
     <table:table-cell table:style-name="ce14"/>
     <table:table-cell table:number-columns-repeated="203"/>
...
function prnxml(){
    ...
    . "WHERE (`cenniki`.`kvo_cennik` >0  AND `cenniki`.`tip_cn`='m' >0)\n"
    . " ";
   ...
   //echo $txt_sql . '<br>';
    ...
    $ok = FALSE;
    if($rows>0) $ok = TRUE;
    $c=0;  // номер текущей строки
    $kvo_cn = mysql_result($sql, $c, 4); // возвращает значения рядка:$c колонки: `cenniki`.`kvo_cennik`
    $break_page = FALSE;
    $kvo_kol=-1;
...
//        echo 'kvo_cn='.$kvo_cn;
         for ($j = 0; $j < 6; $j++) {
            ...
            $cena_kropt[$j]=0;$txt_kropt[$j]='кр.опт';$cena_opt[$j]=0;$txt_opt[$j]='опт'; 
         }
        ...
        } // цикл по количеству колонок формируем массивы данных

        $kvo_kol++;  // количество строк выведенных на лист
        if($kvo_kol == 20){
           $break_page = TRUE; 
           $kvo_kol=0;
        }
...
<office:document xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:presentation="urn:oasis:names:tc:opendocument:xmlns:presentation:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:config="urn:oasis:names:tc:opendocument:xmlns:config:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:field="urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0" xmlns:formx="urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2" office:mimetype="application/vnd.oasis.opendocument.spreadsheet">
 <office:meta><meta:initial-creator>san </meta:initial-creator><meta:creation-date>2014-01-11T14:51:27</meta:creation-date><dc:creator>san </dc:creator><dc:date>2014-09-29T16:11:35</dc:date><meta:print-date>2014-01-11T15:34:15</meta:print-date><meta:editing-cycles>5</meta:editing-cycles><meta:editing-duration>PT20M6S</meta:editing-duration><meta:generator>LibreOffice/3.5$Linux_X86_64 LibreOffice_project/350m1$Build-2</meta:generator><meta:document-statistic meta:table-count="1" meta:cell-count="72" meta:object-count="0"/></office:meta>
 <office:settings>
  <config:config-item-set config:name="ooo:view-settings">
   <config:config-item config:name="VisibleAreaTop" config:type="int">262</config:config-item>
   <config:config-item config:name="VisibleAreaLeft" config:type="int">0</config:config-item>
   <config:config-item config:name="VisibleAreaWidth" config:type="int">19642</config:config-item>
   <config:config-item config:name="VisibleAreaHeight" config:type="int">4726</config:config-item>
  ...
  <config:config-item-set config:name="ooo:configuration-settings">
   ...
   <config:config-item config:name="PrinterSetup" config:type="base64Binary"></config:config-item>
   <config:config-item config:name="ShowNotes" config:type="boolean">true</config:config-item>
 ...
 <office:automatic-styles>
  ...
  <style:style style:name="ro11" style:family="table-row">
   <style:table-row-properties style:row-height="0.05cm" fo:break-before="auto" style:use-optimal-row-height="false"/>
  </style:style>
  <style:style style:name="ro111" style:family="table-row">
   <style:table-row-properties style:row-height="0.05cm" fo:break-before="page" style:use-optimal-row-height="false"/>
  </style:style>
  ...
  <style:style style:name="ce6" style:family="table-cell" style:parent-style-name="Default">
   <style:table-cell-properties fo:border-bottom="0.06pt solid #000000" fo:border-left="none" fo:padding="0.071cm" fo:border-right="none" fo:border-top="none"/>
  </style:style>
 ...
 <office:master-styles>
  ...
  <style:master-page style:name="Report" style:page-layout-name="pm2">
   <style:header>
    ...
    <style:region-right>
     <text:p><text:date style:data-style-name="N2" text:date-value="2017-02-28">00.00.0000</text:date>, <text:time>00:00:00</text:time></text:p>
    </style:region-right>
   </style:header>
   <style:header-left style:display="false"/>
   <style:footer>
 ...
 <office:body>
  <office:spreadsheet>
   ...
   <table:table table:name="Лист1" table:style-name="ta1">
    ...
    <table:table-column table:style-name="co3" table:default-cell-style-name="ce7"/>
    <table:table-column table:style-name="co4" table:default-cell-style-name="ce7"/>
    <table:table-column table:style-name="co5" table:number-columns-repeated="203" table:default-cell-style-name="ce7"/>
    ';


  $end = '    <table:table-row table:style-name="ro3" table:number-rows-repeated="1000">
