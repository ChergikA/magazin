    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function prnhkod( kod1c,kvoprihod,kvo ){
                ...
                document.location = "doc_komplekt.php?id_doc=" + iddoc + "&kod1c=" + kod1c + "&kvoprn=" + kvoprihod  ;
            ...
            function re_h_kod(){
                ...
                document.location = "doc_komplekt.php?id_doc=" + iddoc + "&h_kod=" + h_kod + "&kvo=" + kvo  ;
            }
            ...
            function otmena_h_kod(){
                var iddoc = <?php echo $id_doc; ?> ;
                document.location = "doc_komplekt.php?id_doc=" + iddoc ;
            }
            ...
            function re_skidka_str(){
                ...
                document.location = "doc_komplekt.php?id_doc=" + iddoc + "&idstr=" + idstr + "&newcena=" + newskidka ;
            }
            ...
            function re_pometka(){
                ...
                //alert('=' + document.frm_searh.skidka_doc.value + ' iddoc= ' + iddoc  );
                if(idstr == '') {
                   document.location = "doc_komplekt.php?id_doc=" + iddoc + "&pometka=" + newpometka ;
                }else{
                   document.location = "doc_komplekt.php?id_doc=" + iddoc + "&idstr=" + idstr + "&pometka=" + newpometka  ;
                }
            ...
            function delstr(idstr ){
                var iddoc = <?php echo $id_doc; ?> ;
                document.location = "doc_komplekt.php?id_doc=" + iddoc + "&delstr=" + idstr  ;
            }
            ...
            function prodano(){
                var iddoc = <?php echo $id_doc; ?> ;
                document.location = "doc_komplekt.php?id_doc=" + iddoc + "&prodano=ok";
            ...
            function ne_prodano(){
                var iddoc = <?php echo $id_doc; ?> ;
                document.location = "doc_komplekt.php?id_doc=" + iddoc + "&prodano=no";
            ...
            <tr>
                ...
                <td> <!-- средняя колонка основной таблицы -->
                    ...
                    <div>
                        ...
                        <h3 style="text-align: center" >Если в примечании написано, что это НЕХВАТКА</h3>
                        <p> &#9675; В первой строке товар и количество, которое не смог отгрузить центральный компьютер </p>
                        <p> &#9675; Первую строку редактировать не нужно. </p>
                        <p> &#9675; Если это пересортица, то во второй строке вставьте товар, который необходимо было списывать, <br>
                             количество товара второй строки спишется со склада </p>
                        <p> &#9675; Если это "находка", то просто нажмите кнопку "Принять" </p> 
                        
                       <h3 style="text-align: center" >Создание набора из различных товаров</h3>
                        <p> &#9675; Первым набираем код и количество товара, который является набором.</p>
                        <p> &#9675; Далее набираем коды и количество товара, из которых состоит набор. </p>
                        <p> &#9675; В одном документе можно создать только один набор, <br>
                            в набор может входить несколько различных товаров. </p>
